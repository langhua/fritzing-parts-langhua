...
共 113 个元件（含 `_rev_1` 等变体）；`FPC05-2H10PX`、`SYB-118`、`LM393-A3144-HALL-3PINS`
...
[![连接器与开关：TypeC16Pin、USB-B01、FPC-05F-12P-H15、RJ45-8P8C、SMA-PJ1.7-L9.5、MX-1.25-3P-V、PH-2.0-3P-V、SH-1.0-3P-V、DPDT7x7-6P、SK-12D02VG3、PB86-A0 六色等](docs/preview/conn.svg)](docs/preview/conn.svg)
...
> 下表由 `fzpz/` 目录自动核对生成（118 个 `.fzpz`），全部部件源文件在 `svg/<部件>/` 下，生成脚本为 `gen_part.py` 等。
