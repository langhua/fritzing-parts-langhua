...
def gen_pcb_svg():
    ...
    · 焊盘外径/孔径取 **1.20 / 0.70** —— 实物是 1.60/1.00，但蛇形里最近的两个焊盘
      中心距只有 1.81，1.60 的外径在 Fritzing 里几乎粘在一起（用户 2026-09-17），故缩小显示。
    ...
    """
    PAD_D, HOLE_D = 1.20, 0.70                  # 显示用（用户 2026-09-17：原来 1.60/1.00 太大、几乎粘在一起）
